...
def load_data(spark, file_path):
    ...
    df.show()  # Debugging: Show first few rows to verify data loading
    return df
...
def map_engagement_level(df):
    ...
    """
    return df.withColumn("EngagementScore", 
...
def compare_engagement_levels(df):
    ...
    result_df.show()  # Debugging: Show the output before writing
    return result_df
...
def write_output(result_df, output_path):
    ...
    print("Writing output to:", output_path)  # Debugging
...
def main():
    ...
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-JyotikaKoneru/outputs/task3/engagement_levels_job_titles.csv"
